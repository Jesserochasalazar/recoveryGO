      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content}>
        ...
        <View style={[styles.card, styles.cardAccent]}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Ionicons name="sparkles-outline" size={20} color="#111827" style={{ marginRight: 8 }} />
            <View>
              <Text style={styles.cardTitleDark}>AI Recommendation Ready</Text>
              <Text style={styles.cardSubDark}>Based on your knee surgery recovery</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={[styles.outlineBtn, { marginTop: 14 }]}>
            <Text style={styles.outlineBtnText}>View Details</Text>
          </TouchableOpacity>
        </View>

        {/* Create Custom Plan (this replaces your Link/asChild) */}
        <TouchableOpacity
          style={[styles.outlineBtn, { marginTop: 12 }]}
          accessibilityRole="button"
          onPress={() => {
            // ⚠️ Make sure this route exists; if not, change to a route you do have.
            // e.g. create app/patient/manual-builder.tsx or change to '/(tabs)/plans'
            router.push('/patient/manual-builder');
          }}
        >
...
const styles = StyleSheet.create({
  ...
  cardAccent: {
    backgroundColor: '#A7F3D0', // minty accent
  },
